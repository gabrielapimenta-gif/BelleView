...
Copie e cole no site:
 www.plantuml.com/plantuml                                                                                                                                            @startuml
...
class VendasDetalhe {
    Integer idVendasDetalhe
    Integer idPagamento
}

Cliente "1" -- "0..*" Avaliacoes
Cliente "1" -- "0..*" Agendamentos
Cliente "1" -- "0..*" VendasDetalhe

Funcionario "1" -- "0..*" Agendamentos

Procedimentos "1" -- "0..*" Avaliacoes
Procedimentos "1" -- "0..*" Agendamentos
Procedimentos "1" -- "0..*" Vendas
Procedimentos "1" -- "0..*" VendasDetalhe

Vendas "1" -- "0..*" VendasDetalhe
